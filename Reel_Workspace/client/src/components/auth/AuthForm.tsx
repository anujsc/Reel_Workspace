  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background">
      ...
      <div className="mb-8 animate-slide-up">
        ...
        <p className="text-muted-foreground text-center">Turn Reels into Knowledge</p>
      </div>

      {/* Form Card */}
      <div className="w-full max-w-sm bento-card animate-slide-up" style={{ animationDelay: '0.1s' }}>
        {/* Toggle */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {errors.email && (
              <p className="text-xs text-destructive mt-1 animate-fade-in">{errors.email}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.password && (
              <p className="text-xs text-destructive mt-1 animate-fade-in">{errors.password}</p>
            )}
          </div>
          ...
          {mode === 'register' && (
            <div className="animate-fade-in">
              ...
              {errors.confirm && (
                <p className="text-xs text-destructive mt-1 animate-fade-in">{errors.confirm}</p>
              )}
            </div>
          )}
